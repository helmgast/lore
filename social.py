...
group_handler = ResourceHandler2(group_strategy)
group_handler.register_urls(social)

conversation_handler = ResourceHandler2(ResourceAccessStrategy(Conversation, 'conversations'))
conversation_handler.register_urls(social)

message_handler = ResourceHandler2(ResourceAccessStrategy(Message, 'messages', parent_strategy=conversation_handler.strategy))
